...
def predict_func(request):
    ...
    if "POST" == request.method:
        ...
        alog_0 = "https://weather-predictor-api.herokuapp.com/api/v1/income_classifier/predict?parent_mlalgorithm=8&version=1.1.1"
        ...
        for i in range(len(data_dict)):
            r = requests.post(alog_0, data_dict[i])
            response = r.json()
            # get location ID
...
test = {"Location_ID": 3,
 "Cloud9am": 3.7053842498945335,
 "Cloud3pm": 3.7237069359428685,
 "Humidity9am": 35.0,
 "Humidity3pm": 33.0,
 "Pressure9am": 1012.2,
 "Pressure3pm": 1009.5,
 ...
 "Temp3pm": 34.9,
 "Rainfall": 0.0,
 "Evaporation": 9.622704697893075,
 "Sunshine": 9.213206202001825,
 "WindGustDir": 5,
 "WindGustSpeed": 50.0,
 "WindDir9am": 2,
 "WindDir3pm": 4,
